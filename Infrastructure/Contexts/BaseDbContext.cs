...
namespace Infrastructure.Contexts
{
    public abstract class BaseDbContext :
        MultiTenantIdentityDbContext<
            ...
            >
    {
        private new ABCSchoolTenantInfo TennantInfo { get; set; }
        ...
        {
            //TennantInfo = tenantInfoContextAccessor.MultiTenantContext.TenantInfo;
        }
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            base.OnConfiguring(optionsBuilder);

            if (!string.IsNullOrEmpty(TennantInfo?.ConnectionString))
            {
                optionsBuilder.UseSqlServer(TennantInfo.ConnectionString, options =>
                {
